...
public class Disk2 {
	...
	public void move(){
		if(bouncesLeft == 0){
			...
			adder = 0;
			yV = 0;
			if(tron.player1.ownsEnemy) tron.player1.ownsEnemy = false;
			if(tron.player2.caughtEnemy) tron.player2.caughtEnemy = false;
